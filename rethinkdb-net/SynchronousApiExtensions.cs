...
namespace RethinkDb
{
    public static class SynchronousApiExtensions
    {
        ...
        public static T Run<T>(this IConnection connection, IScalarQuery<T> queryObject, IDatumConverterFactory datumConverterFactory = null, IExpressionConverter expressionConverter = null, CancellationToken? cancellationToken = null)
        {
            return TaskUtilities.ExecuteSynchronously(() => connection.RunAsync<T>(queryObject, datumConverterFactory, expressionConverter, cancellationToken));
        }

        public static IEnumerable<T> Run<T>(this IConnection connection, ISequenceQuery<T> queryObject, IDatumConverterFactory datumConverterFactory = null, IExpressionConverter expressionConverter = null, CancellationToken? cancellationToken = null)
        {
            return new AsyncEnumerableSynchronizer<T>(() => connection.RunAsync<T>(queryObject, datumConverterFactory, expressionConverter), cancellationToken);
        }
