...
namespace RethinkDb.Test.ConnectionFactories
{
    ...
    public class ReliableConnectionFactoryTests
    {
        ...
        public void DelegateRunISingleObjectQuery()
        {
            ...
            mockConnection.RunAsync(Arg.Any<IDatumConverterFactory>(), Arg.Any<IExpressionConverter>(), (ISingleObjectQuery<int>)null, Arg.Any<CancellationToken>()).Returns(
        ...
        public void RetryRunISingleObjectQuery()
        {
            ...
            errorConnection
                .RunAsync(Arg.Any<IDatumConverterFactory>(), Arg.Any<IExpressionConverter>(), (ISingleObjectQuery<int>)null, Arg.Any<CancellationToken>())
            ...
            errorConnection.Received().RunAsync(Arg.Any<IDatumConverterFactory>(), Arg.Any<IExpressionConverter>(), (ISingleObjectQuery<int>)null, Arg.Any<CancellationToken>());
            // Then another connection was attempted after the error failed.
            successConnection.Received().RunAsync(Arg.Any<IDatumConverterFactory>(), Arg.Any<IExpressionConverter>(), (ISingleObjectQuery<int>)null, Arg.Any<CancellationToken>());
        }
    }
}
